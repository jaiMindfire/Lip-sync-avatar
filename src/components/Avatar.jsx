...
Command: npx gltfjsx@6.5.3 .\public\models\672b58413190e573b30a75f7.glb -o src/components/Avatar.jsx -r public 
*/
...
export function Avatar(props) {
  ...
  const { animations: idleAnimation } = useFBX("/animations/Waving.fbx");
  ...
  const { actions } = useAnimations(
    [idleAnimation[0], waveAnimation[0]],
    group
  );
